...
execute at @e[type=zombie,distance=..100,limit=1,sort=nearest] run summon spider ~ ~ ~ {Silent:1,Tags:["bp.gothrum2","bp.entity","bp.rain_event"],Passengers:[{id:"minecraft:husk",HandItems:[{id:"minecraft:iron_sword",Count:1b,components:{"minecraft:custom_model_data":888506}}],CustomName:'{"text":"Gothrum","color":"dark_green"}',CustomNameVisible:0b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_leggings",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:leather_chestplate",Count:1b,components:{"minecraft:dyed_color":3684408}},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:custom_name":'{"text":"Gothrum Head","italic":false}',"minecraft:custom_model_data":888506}}],Attributes:[{Name:generic.follow_range,Base:64}]}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],DeathLootTable:"bracken:entity/panacea/gothrum2",Health:40f,Attributes:[{Name:generic.scale,Base:2},{Name:generic.max_health,Base:40},{Name:generic.knockback_resistance,Base:0.5}]}
