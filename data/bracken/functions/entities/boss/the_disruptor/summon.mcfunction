...
summon elder_guardian ~ ~ ~ {DeathLootTable:"bracken:entity/boss/the_disruptor",PersistenceRequired:1b,NoAI:1b,Health:350f,Tags:[bp.entity,bp.boss,bp.the_disruptor,bp.the_disruptor.inactive],Attributes:[{Name:generic.max_health,Base:350}]}
