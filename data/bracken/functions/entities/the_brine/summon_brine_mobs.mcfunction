...
#nautilus
execute as @e[type=drowned,tag=!bp.aquatic,distance=..100,limit=1,sort=nearest] at @s run data merge entity @s[y=250,dy=-500] {active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b},{id:"minecraft:speed",amplifier:1b,duration:5b,show_particles:0b}],Tags:[bp.aquatic,bp.nautilus,bp.entity,bp.the_brine],Silent:1b,DeathLootTable:"bracken:entity/the_brine/nautilus",CanPickUpLoot:0b,HandItems:[{id:"minecraft:bamboo",Count:1b,components:{"minecraft:custom_name":'{"text":"Giant Nautilus","italic":false}',"minecraft:custom_model_data":888503}},{id:"minecraft:air"}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],HandDropChances:[0.000F,0.000F],Attributes:[{Name:generic.attack_damage,Base:0},{Name:generic.max_health,Base:10},{Name:generic.movement_speed,Base:0.2}]}

#jellyfish
execute as @e[type=drowned,tag=!bp.aquatic,distance=..100,limit=1,sort=nearest] at @s run data merge entity @s[y=250,dy=500] {active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b},{id:"minecraft:speed",amplifier:1b,duration:5b,show_particles:0b}],Tags:[bp.aquatic,bp.jellyfish,bp.entity,bp.the_brine],Silent:1b,DeathLootTable:"bracken:entity/the_brine/jellyfish",CanPickUpLoot:0b,HandItems:[{id:"minecraft:air"},{id:"minecraft:air"}],ArmorItems:[{},{},{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:custom_model_data":888501,"minecraft:enchantments":{levels:{"minecraft:thorns":3,"minecraft:knockback":10,"minecraft:vanishing_curse":1}}}},{}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],Attributes:[{Name:generic.max_health,Base:10},{Name:generic.movement_speed,Base:0.1}]}
