...
execute if block ~ ~ ~ brewing_stand{Items:[{Slot:0b,tag:{Potion:"minecraft:awkward"}}]} run data modify block ~ ~ ~ Items[{Slot:0b,tag:{Potion:"minecraft:awkward"}}] merge value {tag:{bp.potion:105b,bp:[{id:"custom_potion"}],custom_potion_effects:[{duration:1800,id:"haste",amplifier:0}],CustomPotionColor:13421582,display:{Name:'{"text":"Potion of Haste","italic":false}'}}}
