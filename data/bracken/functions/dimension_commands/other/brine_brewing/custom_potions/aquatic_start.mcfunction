...
execute if block ~ ~ ~ brewing_stand{Items:[{Slot:0b,tag:{Potion:"minecraft:awkward"}}]} run data modify block ~ ~ ~ Items[{Slot:0b,tag:{Potion:"minecraft:awkward"}}] merge value {tag:{bp.potion:101b,bp:[{id:"custom_potion"},{closed_path:"enhance"}],custom_potion_effects:[{duration:3600,id:"dolphins_grace"},{duration:3600,id:"conduit_power"}],CustomPotionColor:4047815,display:{Name:'"Potion of Aquatic Enhancement"'}}}
