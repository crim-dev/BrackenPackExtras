...
execute if data block ~ ~ ~ {Items:[{Slot:3b, id:"minecraft:gunpowder"},{id:"minecraft:potion"}]} run function bracken:dimension_commands/other/brine_brewing/gunpowder/change_to_splash
execute if data block ~ ~ ~ {Items:[{Slot:3b, id:"minecraft:dragon_breath"},{id:"minecraft:splash_potion"}]} run function bracken:dimension_commands/other/brine_brewing/dragon_breath/change_to_lingering
