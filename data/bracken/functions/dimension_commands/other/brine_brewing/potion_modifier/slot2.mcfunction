...
execute unless data block ~ ~ ~ Items[{Slot:2b,components:{"minecraft:custom_data":{bp:[{id:"custom_potion"}]}}}] run function bracken:dimension_commands/other/brine_brewing/potion_modifier/convert_vanilla_potions
