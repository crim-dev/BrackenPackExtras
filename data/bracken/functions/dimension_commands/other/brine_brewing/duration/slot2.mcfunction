...
#execute if data block ~ ~ ~ Items[{Slot:2b,tag:{bp.potion:102b}}] run data modify block ~ ~ ~ Items[{Slot:2b}].tag.bp append value {astral:3b}

scoreboard players set @s bp.brine_potion 0
execute store result score @s bp.brine_potion run data get block ~ ~ ~ Items[{Slot:2b}].tag.bp[1].astral
scoreboard players add @s bp.brine_potion 1
execute if data block ~ ~ ~ Items[{Slot:2b,tag:{bp.potion:102b}}] store result block ~ ~ ~ Items[{Slot:2b}].tag.bp[1].astral byte 1 run scoreboard players get @s bp.brine_potion

scoreboard players set @s bp.brine_potion 0
execute store result score @s bp.brine_potion run data get block ~ ~ ~ Items[{Slot:2b}].tag.bp[1].greed_duration
scoreboard players add @s bp.brine_potion 1
execute if data block ~ ~ ~ Items[{Slot:2b,tag:{bp.potion:104b}}] store result block ~ ~ ~ Items[{Slot:2b}].tag.bp[1].greed_duration byte 1 run scoreboard players get @s bp.brine_potion
