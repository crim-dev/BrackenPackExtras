...
execute if score @s bp.tick matches 2 if blocks ~1 ~1 ~1 ~-1 ~-10 ~-1 ~ 500 ~ all unless entity @s[predicate=bracken:item/wearing_elytra] run effect give @s[gamemode=!creative] minecraft:slow_falling 3 0 true
