execute if data storage bp.vars {varskstorm:{stage:1}} run particle falling_obsidian_tear ~ ~ ~ 100 30 100 1 4 force


execute if data storage bp.vars {varskstorm:{stage:2}} run particle falling_obsidian_tear ~ ~ ~ 50 30 50 0 8 force
execute if data storage bp.vars {varskstorm:{stage:2}} run particle electric_spark ~ ~ ~ 50 30 50 0.2 10 force
