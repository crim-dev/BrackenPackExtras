...
execute if score #count bp.varskstorm matches 6 if data storage bp.vars {varskstorm:{stage:2}} run playsound bracken:varskspace music @a ~ ~ ~ 100 1 0
execute if score #count bp.varskstorm matches 12 if data storage bp.vars {varskstorm:{stage:2}} run data merge storage bp.vars {varskstorm:{stage:3}}
