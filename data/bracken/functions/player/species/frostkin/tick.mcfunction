...
execute positioned over ocean_floor if entity @s[distance=..0.1,predicate=bracken:lightlevel,predicate=bracken:desert,predicate=bracken:item/no_helmet] run function bracken:player/species/frostkin/desert
