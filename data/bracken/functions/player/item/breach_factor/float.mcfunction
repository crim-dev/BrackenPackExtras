...
execute unless predicate bracken:sneaking run function bracken:player/item/breach_factor/float_deactivate

execute if predicate bracken:sneaking if score @s bp.breach_factor_float matches 0 run function bracken:player/item/breach_factor/float_deactivate