...
execute if score @s bp.breach_factor_jump matches 1 run function bracken:player/item/breach_factor/jump
...
execute if score @s bp.breach_factor_float matches 1.. run function bracken:player/item/breach_factor/float
